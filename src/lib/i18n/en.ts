export const en = {
  ...
  dashboard: {
    ...
    goalTargetNote: 'Fixed target: {target} visits / month',
    ofGoal: '% of goal',
    outstandingBalances: 'Outstanding Balances',
    noOutstanding: 'No pending balances',
    ofCourseFee: 'of ₹{fee}',
  ...
  patients: {
    ...
    newPatientSubtitle: 'Register a new client',
  ...
  assessment: {
    ...
    chip: {
      ...
      partial: 'Intake {filled}/5',
      missing: 'Intake pending',
    },
  ...
  receipt: {
    ...
    patientSection: 'CLIENT',
    patientCode: 'Client Code',
    feeSummary: 'FEE SUMMARY',
    totalFee: 'TOTAL FEE',
    totalPaid: 'TOTAL PAID',
    balanceDue: 'BALANCE DUE',
