...
export const mr: Translations = {
  ...
  dashboard: {
    ...
    patientName: 'साधकाचे नाव',
    patientId: 'साधक ओळखपत्र',
    date: 'तारीख',
    weight: 'वजन',
  ...
  patients: {
    ...
    newPatient: 'नवीन साधक',
    searchPlaceholder: 'नाव किंवा मोबाईल शोधा',
    notFound: 'साधक सापडले नाहीत',
    registerFirst: 'पहिला साधक नोंदवा',
    newPatientTitle: 'नवीन साधक',
    newPatientSubtitle: 'नवीन साधक नोंदवा',
  ...
  globalSearch: {
    placeholder: 'साधकाचा शोध घ्या…',
    noResults: 'कोणतेही निकाल नाहीत',
  },
  form: {
    fullName: 'पूर्ण नाव',
    fullNamePlaceholder: 'साधकाचे पूर्ण नाव',
    mobile: 'मोबाईल',
  ...
  print: {
    patientReport: 'साधक अहवाल',
    generatedOn: 'तयार केले',
    patientIdentification: 'साधकाची ओळख',
    personalInfo: 'वैयक्तिक माहिती',
