...
export const mr: Translations = {
  ...
  treatment: {
    ...
    progressNote: 'प्रगती नोंद',
    addVisitBtn: 'भेट जोडा',
    noVisits: 'अद्याप कोणतीही भेट नाही',
    chipBetter: 'बरे वाटत आहे',
    chipWorse: 'त्रास वाढला आहे',
    chipSame: 'काही बदल नाही',
    chipNew: 'तीच योजना सुरू आहे',
  },
  progress: {
    title: 'प्रगती',
